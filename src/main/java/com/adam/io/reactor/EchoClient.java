                ...
                while (it.hasNext()){
                    ...
                    if(key.isWritable()){
                        ...
                        if(scanner.hasNextLine()){
                            ...
                            System.out.println("channel:" + key.channel() + ".key hashcode:"+ key.hashCode() +
                                    ". key string:" + key.toString());
                            System.out.println("channel1:" + channel1 + ".key hashcode:"+ key.hashCode() +
                                    ". key string:" + key.toString());
                            try {
